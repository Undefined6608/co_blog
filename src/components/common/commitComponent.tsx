...
const CommitComponent: React.ForwardRefRenderFunction<HTMLDivElement, CommitComponentParam> = (props, ref) => {
    ...
    return (
        <div className={"commitComponent"} ref={ref}
             style={{minHeight: param.height, width: param.width, marginTop: param.marginTop}}>
            <Card title="评论区" className={"inputCommitBox"} bordered={false}
            ...
            <Card title="评论列表" className={"commitsList"} bordered={false}
                  bodyStyle={{width: '100%'}}>
                {
                    commitStatus ?
                        <List
