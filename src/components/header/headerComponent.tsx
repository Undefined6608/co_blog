...
const HeaderComponent: React.FC<SizeInterface> = ({param}) => {
    ...
    return (
        <div className={"headerBox"} style={{width: param.width, height: param.height}}>
            <div className="header">
                ...
                <div className="header-right">
                    ...
                    <CommonInputBox param={{width: "256px", height: "33px"}}/>
                    <div className="icon-item">
                        <img src="/static/images/github.png" alt=""/>
                    </div>
                    <UserBtn param={{width:"24px", height:"72px"}} />
                    <HeaderMenu param={{width: "24px", height: "24px"}}/>
                </div>
            </div>
        </div>
    )
