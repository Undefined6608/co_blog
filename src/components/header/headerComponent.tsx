 ...
 * @returns
 */
const HeaderComponent: React.FC<HeaderComponentParam> = ({
  param,
  menuShow,
}) => {
  // 状态变量
        ...
        <div className="header-right">
          ...
          >
            <motion.div className="handle" layout transition={spring}>
              <img
                className={"btnImg"}
                src={isOn ? "/static/images/mon.png" : "/static/images/sun.png"}
                alt=""
              />
            </motion.div>
          </div>
          ...
          <Link to={"/about"} className={"btn-list"}>
            About
          </Link>
          <CommonInputBox
            param={{ width: "256px", height: "33px", marginTop: "0" }}
          />
          <div className="icon-item" onClick={click}>
            <img
              className={isOn ? "img-dark" : ""}
          ...
          <HeaderMenu
            param={{ width: "24px", height: "24px", marginTop: "0" }}
            menuShow={menuShow}
          />
        </div>
      </div>
