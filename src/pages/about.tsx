      ...
      <Watermark {...watermarkProps}>
        <div className={"about"}>
          ...
          <div className={"editMsg"}>
            <span>
              Version: <span className={"version"}>1.3.10</span>
            </span>
            <span>
              Author: <span className={"authorName"}>ZbvcDevelopmentTeam</span>
            </span>
            <span>
              QQ: <span className={"authorQQ"}>1105149059</span>
            </span>
            <span>
              Email: <span className={"authorEmail"}>15506531157@163.com</span>
            </span>
